				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="service-box rounded data-background padding-30 text-center text-light shadow-blue"
							data-color="#6C6CE5">
							<h3 class="mb-3 mt-0">Microsoft Certified: Azure Fundamentals</h3>
							<p class="mb-0">Issued May 2023</p>
							<p>Credential ID 1766-9124</p>
							<div class="mt-3">
								<a href="/doc/Certifications - rambabu-8945 _ Microsoft Learn.pdf" target="_blank" class="btn btn-default">View
									Certificate</a>
							</div>
						</div>
					...
					<div class="col-md-4">
						<!-- service box -->
						<div class="service-box rounded data-background padding-30 text-center text-light shadow-yellow"
							data-color="#F9D74C">
							<h3 class="mb-3 mt-0">Cloud Fundamentals</h3>
							<p class="mb-0">Issued Mar 2023</p>
							</p>Credential ID 41484E/EXLR/30032023</p>
							<div class="mt-3">
								<a href="/doc/CF-EDL-41484-Ram Babu.pdf" target="_blank" class="btn btn-default">View
									Certificate</a>
							</div>
						</div>
						<div class="spacer d-md-none d-lg-none" data-height="30"></div>
					...
					<div class="col-md-4">
						...
						<div class="service-box rounded data-background padding-30 text-center text-light shadow-blue"
							data-color="#6C6CE5">
							<h3 class="mb-3 mt-0">Python Certificate</h3>
							<p class="mb-0">HackerRank Certificates</p>
							<p class="mb-0">Issued May 2023</p>
							<div class="mt-3">
								<a href="/doc/python_basic certificate.pdf" target="_blank" class="btn btn-default">View
									Certificate</a>
							</div>
						</div>
						<div class="spacer d-md-none d-lg-none" data-height="30"></div>
